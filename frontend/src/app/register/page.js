    ...
    <div className="min-h-screen flex items-center justify-center bg-[#030712] px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md glass-panel p-8 rounded-2xl glow-indigo border border-slate-800/80 shadow-2xl relative z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-slate-500 mt-1">Join Placement Intelligence Platform</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            />
            {fieldErrors.name && (
              <span className="text-xs text-rose-400 mt-1 block">{fieldErrors.name}</span>
            )}
          </div>
          ...
          <div>
            ...
            />
            {fieldErrors.email && (
              <span className="text-xs text-rose-400 mt-1 block">{fieldErrors.email}</span>
            )}
          </div>
          ...
          <div>
            ...
            <span className="text-slate-500 text-[10px] block mt-1 font-mono">
              Must be 8+ chars, contain 1 uppercase, 1 lowercase, 1 number.
            </span>
            {fieldErrors.password && (
              <span className="text-xs text-rose-400 mt-1 block">{fieldErrors.password}</span>
            )}
          </div>
